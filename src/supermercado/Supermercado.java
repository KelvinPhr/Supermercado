...
public class Supermercado{
    ...
    private static void CriarFuncionarios(){
        ...
        OperadorDeCaixa funcionario1 = new OperadorDeCaixa("Manoel", "f1", "1111" );
        OperadorDeCaixa funcionario2 = new OperadorDeCaixa("Pedro", "f2", "1122"  );
        OperadorDeCaixa funcionario3 = new OperadorDeCaixa("Maria", "f3", "1133" );
        OperadorDeCaixa funcionario4 = new OperadorDeCaixa("Juliana", "f4", "1144"  );
        OperadorDeCaixa funcionario5 = new OperadorDeCaixa("Sergio","f5", "1155" );
